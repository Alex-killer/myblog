...
<div class="row justify-content-center">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <button type="submit" class="btn btn-primary">Сохранить</button> {{-- т.к. находимя внутри формы, то просто пишем submit и она будет отправлять --}}
            </div>
        </div>
    </div>
</div>
@if($item->exists) {{-- если элемент существует, то выполняем --}}
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
