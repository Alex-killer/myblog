                    ...
                    <table class="table table-striped projects">
                        ...
                        <tr>
                            ...
                            <td class="project-actions text-right">
                                <a class="btn btn-info btn-sm" href="{{ route('blog.admin.articles.edit', $item->id) }}"> {{-- $item->id - передаем id категории которую редактируем --}}
                                    <i class="fas fa-pencil-alt">
                                    </i>
                                    Редактировать
                                </a>
                                <form action="{{ route('blog.admin.articles.destroy', $item->id) }}" method="POST" style="display: inline-block">
                                    @csrf
                                    @method('DELETE')
